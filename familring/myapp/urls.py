...
from .views import (
    register, login, get_bucketlists, add_bucketlist, complete_bucketlist, delete_bucketlist, update_bucket,
...
urlpatterns = [
    ...
    path('bucket/update/<int:bucket_id>/', update_bucket, name='update_bucket'),
